...
// 应用程序基本信息
constexpr std::wstring_view APP_NAME = L"SpinningMomo";
constexpr std::wstring_view WINDOW_CLASS = L"SpinningMomoClass";
...
// 配置文件相关
constexpr std::wstring_view CONFIG_FILE = L"config.ini";  // 配置文件名

// 项目文档URL
constexpr std::wstring_view DOC_URL_ZH = L"https://chaniok.github.io/SpinningMomo/";
constexpr std::wstring_view DOC_URL_EN = L"https://chaniok.github.io/SpinningMomo/en/";

// 配置节和配置项
constexpr std::wstring_view WINDOW_SECTION = L"Window";  // 窗口配置
constexpr std::wstring_view WINDOW_TITLE = L"Title";     // 窗口标题配置项

constexpr std::wstring_view SCREENSHOT_SECTION = L"Screenshot";  // 截图配置节名
constexpr std::wstring_view SCREENSHOT_PATH = L"GameAlbumPath";  // 游戏相册路径配置项

constexpr std::wstring_view HOTKEY_SECTION = L"Hotkey";       // 热键配置节名
constexpr std::wstring_view HOTKEY_MODIFIERS = L"Modifiers";  // 修饰键配置项
constexpr std::wstring_view HOTKEY_KEY = L"Key";              // 主键配置项

// 自定义比例和分辨率配置项
constexpr std::wstring_view CUSTOM_RATIO_LIST = L"CustomRatioList";  // 自定义比例列表配置项
constexpr std::wstring_view CUSTOM_RESOLUTION_LIST =
    L"CustomResolutionList";  // 自定义分辨率列表配置项

// 语言相关
constexpr std::wstring_view LANG_SECTION = L"Language";  // 语言配置节名
constexpr std::wstring_view LANG_CURRENT = L"Current";   // 当前语言配置项
constexpr std::wstring_view LANG_ZH_CN = L"zh-CN";       // 中文
constexpr std::wstring_view LANG_EN_US = L"en-US";       // 英文

constexpr std::wstring_view TASKBAR_SECTION = L"Taskbar";      // 任务栏配置节名
constexpr std::wstring_view TASKBAR_AUTOHIDE = L"AutoHide";    // 任务栏自动隐藏配置项
constexpr std::wstring_view TASKBAR_LOWER = L"LowerOnResize";  // 调整时置底任务栏配置项

constexpr std::wstring_view MENU_SECTION = L"Menu";       // 菜单配置节名
constexpr std::wstring_view MENU_FLOATING = L"Floating";  // 浮动窗口配置项

// 菜单项类型字符串
constexpr std::wstring_view MENU_ITEM_TYPE_CAPTURE = L"CaptureWindow";
constexpr std::wstring_view MENU_ITEM_TYPE_SCREENSHOT = L"OpenScreenshot";
constexpr std::wstring_view MENU_ITEM_TYPE_OVERLAY = L"OverlayWindow";
constexpr std::wstring_view MENU_ITEM_TYPE_PREVIEW = L"PreviewWindow";
constexpr std::wstring_view MENU_ITEM_TYPE_RESET = L"Reset";
constexpr std::wstring_view MENU_ITEM_TYPE_CLOSE = L"Close";
constexpr std::wstring_view MENU_ITEM_TYPE_EXIT = L"Exit";
constexpr std::wstring_view MENU_ITEM_TYPE_LETTERBOX = L"LetterboxWindow";

// 菜单项配置
constexpr std::wstring_view MENU_ITEMS = L"MenuItems";  // 菜单项显示配置

// 宽高比和分辨率配置
constexpr std::wstring_view ASPECT_RATIO_ITEMS = L"AspectRatioItems";  // 宽高比项目显示配置
constexpr std::wstring_view RESOLUTION_ITEMS = L"ResolutionItems";     // 分辨率项目显示配置

constexpr std::wstring_view LETTERBOX_SECTION = L"Letterbox";  // 黑边模式配置节名
constexpr std::wstring_view LETTERBOX_ENABLED = L"Enabled";    // 黑边模式启用配置项

constexpr std::wstring_view LOGGER_SECTION = L"Logger";  // 日志配置节名
constexpr std::wstring_view LOGGER_LEVEL = L"LogLevel";  // 日志级别配置项

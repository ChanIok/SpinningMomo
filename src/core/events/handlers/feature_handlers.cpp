...
auto register_feature_handlers(Core::State::AppState& app_state) -> void {
  ...
  subscribe<UI::FloatingWindow::Events::CaptureEvent>(
      app_state, [&app_state](const UI::FloatingWindow::Events::CaptureEvent& event) {
  ...
  subscribe<UI::FloatingWindow::Events::RatioChangeEvent>(
      app_state, [&app_state](const UI::FloatingWindow::Events::RatioChangeEvent& event) {
  ...
  subscribe<UI::FloatingWindow::Events::ResolutionChangeEvent>(
      app_state, [&app_state](const UI::FloatingWindow::Events::ResolutionChangeEvent& event) {
  ...
  subscribe<UI::FloatingWindow::Events::WindowSelectionEvent>(
      app_state, [&app_state](const UI::FloatingWindow::Events::WindowSelectionEvent& event) {
  ...
  subscribe<UI::FloatingWindow::Events::RecordingToggleEvent>(
      app_state, [&app_state](const UI::FloatingWindow::Events::RecordingToggleEvent&) {

...
// 流式传输阈值：超过此大小使用流式传输
export constexpr size_t STREAM_THRESHOLD = 1024 * 1024;  // 1MB

// 流式传输块大小
export constexpr size_t STREAM_CHUNK_SIZE = 65536;  // 64KB

// 流式传输上下文（完整状态）
export struct StreamContext {
  // 文件相关
...
export struct PathResolutionData {
  std::filesystem::path file_path;

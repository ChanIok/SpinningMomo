...
当调整后的窗口尺寸超出物理屏幕时，可根据需求选择开启**预览窗**或**叠加层**辅助画面观察与操作：

- **预览窗**：类似 Photoshop 导航器，可实时预览超出屏幕的完整画面，支持滚轮缩放与拖拽移动。
- **叠加层**：类似 Magpie 的反向缩小显示。将超出屏幕的大窗口捕获并全屏等比缩小渲染，通过动态位置同步保持超大分辨率下的鼠标点击与交互体验。
- **黑边模式**：在窗口底部铺设全屏黑色背景，遮蔽桌面内容，为非屏幕原生比例提供纯净的沉浸式体验。

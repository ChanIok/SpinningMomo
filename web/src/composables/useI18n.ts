...
export function useI18n() {
  ...
  // TODO: Implement actual i18n logic or port from React
  const t = (key: string) => {
    const map: Record<string, string> = {
      ...
      'settings.general.description': '管理应用的通用配置，包括语言、日志和快捷键。',
      ...
      'settings.general.hotkey.toggleVisibility': '显示/隐藏',
      'settings.general.hotkey.toggleVisibilityDescription': '切换应用主窗口的显示和隐藏。',
      'settings.general.hotkey.screenshot': '截图',
      'settings.general.hotkey.screenshotDescription': '触发截图功能的快捷键。',
      'settings.layout.function.title': '功能',
      'settings.layout.function.description': '功能配置',
      'settings.layout.menu.title': '菜单',
      'settings.layout.menu.description': '菜单配置',
      'settings.layout.appearance.title': '外观',
      'settings.layout.appearance.description': '界面外观',
      ...
      'settings.function.windowControl.windowTitle.description': '应用将吸附的目标窗口名称。',
      'settings.function.windowControl.windowTitle.placeholder': '输入窗口标题...',
      'settings.function.windowControl.windowTitle.update': '更新',
      'settings.function.windowControl.taskbarLowerOnResize.label': '调整大小时置得任务栏',
      'settings.function.windowControl.taskbarLowerOnResize.description': '调整窗口大小时自动将任务栏置底。',
      'settings.function.screenshot.title': '截图设置',
      'settings.function.screenshot.description': '配置截图保存路径。',
      'settings.function.screenshot.directory.label': '保存目录',
      'settings.function.screenshot.directory.description': '截图文件的保存位置。',
      'settings.function.screenshot.directory.placeholder': '选择目录...',
      'settings.function.screenshot.directory.selectButton': '选择',
      'settings.function.screenshot.directory.selecting': '选择中...',
      'settings.function.screenshot.directory.dialogTitle': '选择截图保存目录',
      'settings.function.letterbox.title': '黑边设置',
      'settings.function.letterbox.description': '配置黑边遮罩功能。',
      'settings.function.letterbox.enabled.label': '启用黑边',
      'settings.function.letterbox.enabled.description': '在非标准比例下显示黑边。',
      'settings.function.recording.title': '录制设置',
      'settings.function.recording.description': '配置屏幕录制功能参数。',
      'settings.function.recording.outputDir.label': '输出目录',
      'settings.function.recording.outputDir.description': '录制文件的保存位置（空为默认目录）。',
      'settings.function.recording.outputDir.placeholder': '选择目录...',
      'settings.function.recording.outputDir.selectButton': '选择',
      'settings.function.recording.outputDir.selecting': '选择中...',
      'settings.function.recording.outputDir.dialogTitle': '选择录制保存目录',
      ...
      'settings.function.recording.bitrate.description': '视频编码的比特率（Mbps）。',
      ...
      // Menu Items Labels
      'settings.menu.items.screenshotCapture': '截图',
      'settings.menu.items.screenshotOpenFolder': '打开截图目录',
      'settings.menu.items.featureTogglePreview': '切换预览',
      'settings.menu.items.featureToggleOverlay': '切换覆盖',
      'settings.menu.items.featureToggleLetterbox': '切换黑边',
      'settings.menu.items.windowResetTransform': '重置变换',
      'settings.menu.items.panelHide': '隐藏面板',
      'settings.menu.items.appExit': '退出应用',
      ...
      'settings.appearance.background.opacity.label': '不透明度',
      'settings.appearance.background.opacity.description': '调整背景的不透明度。',
      'settings.appearance.background.blurAmount.label': '模糊度',
      'settings.appearance.background.blurAmount.description': '调整背景的模糊程度。',
      ...
      'settings.appearance.theme.title': '主题设置',
      'settings.appearance.theme.description': '切换明亮/暗黑主题。',
      'settings.appearance.theme.mode.label': '应用主题',
      'settings.appearance.theme.mode.description': 'Web 界面主题模式。',
      'settings.appearance.theme.light': '浅色',
      'settings.appearance.theme.dark': '深色',
      'settings.appearance.theme.system': '跟随系统',
      'settings.appearance.appWindowTheme.label': '窗口主题',
      'settings.appearance.appWindowTheme.description': 'App 窗口（UI 边框）的主题模式。',
      'settings.appearance.appWindowTheme.light': '浅色',
      'settings.appearance.appWindowTheme.dark': '深色',

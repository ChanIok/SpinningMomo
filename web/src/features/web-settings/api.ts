...
/**
 * Get current environment (mock for now if not available)
 * TODO: port getCurrentEnvironment from react or implementation
 */
const getCurrentEnvironment = () => {
    // Basic detection or default to 'web'
    // If window.pywebview exists, it might be webview.
    // For now, assume web or webview doesn't strictly matter for initial port except for dialog mode.
    // Using simple check.
    return (window as any).pywebview ? 'webview' : 'web' // Simplified
}

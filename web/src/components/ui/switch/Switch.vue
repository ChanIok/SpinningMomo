...
<template>
  <SwitchRoot
    ...
    :class="
      cn(
        'peer inline-flex h-[1.15rem] w-8 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-primary data-[state=checked]:hover:bg-primary/85 data-[state=unchecked]:bg-input data-[state=unchecked]:hover:border-primary/50 dark:data-[state=unchecked]:bg-input/80 dark:data-[state=unchecked]:hover:border-primary/80',
        props.class
      )
    "
  >

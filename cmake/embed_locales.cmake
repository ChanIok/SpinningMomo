# 嵌入所有语言文件的函数 使用add_custom_command实现增量构建
function(embed_all_locales)
  ...
  add_custom_command(
    OUTPUT "${zh_output}"
    COMMAND
      ${CMAKE_COMMAND} -DINPUT_FILE=${zh_input} -DOUTPUT_FILE=${zh_output}
      -DMODULE_NAME=Core.I18n.Embedded.ZhCN -DVARIABLE_NAME=zh_cn_json -P
      ${CMAKE_SOURCE_DIR}/cmake/generate_locale.cmake
  ...
  add_custom_command(
    OUTPUT "${en_output}"
    COMMAND
      ${CMAKE_COMMAND} -DINPUT_FILE=${en_input} -DOUTPUT_FILE=${en_output}
      -DMODULE_NAME=Core.I18n.Embedded.EnUS -DVARIABLE_NAME=en_us_json -P
      ${CMAKE_SOURCE_DIR}/cmake/generate_locale.cmake

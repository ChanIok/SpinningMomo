...
# ==============================================================================
# 此脚本负责处理Web应用资源的复制
# 仅在 Release 模式下复制已构建的前端资源，Debug 模式使用 Vite 开发服务器
    ...
    if(BUILD_TYPE_UPPER STREQUAL "RELEASE")
        ...
        if(EXISTS ${CMAKE_SOURCE_DIR}/web/dist)
            ...
            add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
                ...
                COMMENT "Copying pre-built web app resources to Release output directory..."
            )

            message(STATUS "Web app copy enabled for Release: using pre-built resources from web/dist")
        else()
            message(WARNING "web/dist not found - web app resources will not be copied")
...
# 使用方法: setup_web_app_copy(SpinningMomo)